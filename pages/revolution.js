...
export default function Revolution(props) {
  ...
  const sections = [
    {
      ...
      title: "Consultation",
      paragraphs: [
        `The process begins the moment you realize you need a piece of technology for your business. Whether you already have an idea for
  ...
  return (
    <Grid container direction="column" className={classes.background}>
      <Head>
        <title key="title">
          The Tech Splash - Cutting-Edge Software | MiaCodes
        </title>
        <meta
          name="description"
          key="description"
        ...
        <meta
          property="og:title"
          content="Bringing West Coast Technology to the Mountain Region | The Tech Splash"
          key="og:title"
        />
        <meta
          property="og:url"
          key="og:url"
          content="arc.com/revolution"
        />
        <link
          rel="canonical"
          key="canonical"
          href="arc.com/revolution"
        />
      </Head>
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              websites. This new system, React.js, completely
            ...
            >
              ...
              traditional websites, React websites are built with
              little chunks of code called components. These
              components are faster, easier to maintain, and are
            ...
            >
              ...
              similar system, React Native, for producing iOS and
              Android apps. Instead of having to master two completely
              separate development platforms, you can leverage the
              knowledge you already possessed from building websites
              and reapply it directly! This was a huge leap forward.
            </Typography>
            <Typography
              align={matchesMD ? "center" : undefined}
              variant="body1"

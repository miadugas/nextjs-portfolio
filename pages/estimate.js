...
export default function Estimate() {
  ...
  const navigationNextDisabled = () => {
    ...
    if (
      currentlyActive[0].id === questions[questions.length - 1].id
    ) {
      return true;
    } else {
      return false;
  ...
  return (
    <Grid container direction="row">
      <Head>
        <title key="title">
          Free Custom Software Estimate | MiaCodes
        </title>
        <meta
          name="description"
          key="description"
        ...
        <meta
          property="og:title"
          content="Bringing West Coast Technology to the Mountain Region | Free Estimate"
          key="og:title"
        />
        <meta
          property="og:url"
          key="og:url"
          content="miacodes.com/estimate"
        />
        <link
          rel="canonical"
          key="canonical"
          href="miacodes.com/estimate"
        />
      </Head>
